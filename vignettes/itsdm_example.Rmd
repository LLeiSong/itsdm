...
#> [Training dataset]:
#> bio12     With only: #################################### 0.807
#>           Without  : ########################################### 0.963
#> bio18     With only: ############################## 0.674
#>           Without  : ############################################ 0.979
#> bio3      With only: ############################# 0.643
#>           Without  : ############################################ 0.976
#> landcover With only: ########################### 0.605
#>           Without  : ############################################# 0.99
#> bio6      With only: ######################## 0.538
#>           Without  : ############################################ 0.984
#> bio19     With only: ####################### 0.501
#>           Without  : ########################################### 0.963
#> wdpa      With only: ################### 0.429
#>           Without  : ############################################ 0.988
#> bio1      With only: ################### 0.429
#>           Without  : ############################################ 0.981
#> bio2      With only: ################ 0.366
#>           Without  : ############################################ 0.978
#> bio14     With only: ############### 0.338
#>           Without  : ############################################ 0.987
#> [Test dataset]:
#> bio12     With only: #################################### 0.803
#>           Without  : ########################################### 0.962
#> bio3      With only: ############################# 0.635
#>           Without  : ############################################ 0.977
#> bio18     With only: ########################### 0.604
#>           Without  : ############################################ 0.981
#> landcover With only: ######################### 0.566
#>           Without  : ############################################# 0.99
#> bio19     With only: ######################## 0.538
#>           Without  : ########################################### 0.96
#> bio6      With only: ###################### 0.492
#>           Without  : ############################################ 0.983
#> wdpa      With only: ################### 0.413
#>           Without  : ############################################ 0.988
#> bio1      With only: ################## 0.409
#>           Without  : ############################################ 0.982
#> bio14     With only: ################ 0.358
#>           Without  : ############################################ 0.987
#> bio2      With only: ############### 0.33
#>           Without  : ############################################ 0.977
#> ======================================================================
...
#> [Training dataset]:
#> bio12     With only: ###################################### 0.848
#>           Without  : ###################################### 0.835
#> bio18     With only: #################################### 0.794
#>           Without  : ####################################### 0.866
#> bio3      With only: ################################## 0.758
#>           Without  : ######################################## 0.883
#> bio6      With only: ################################# 0.726
#>           Without  : ####################################### 0.871
...
#>           Without  : ####################################### 0.876
#> bio2      With only: ############################## 0.663
#>           Without  : ####################################### 0.857
#> bio19     With only: ######################## 0.523
#>           Without  : ####################################### 0.877
#> bio14     With only: #################### 0.441
#>           Without  : ######################################## 0.885
#> [Test dataset]:
#> bio12     With only: ##################################### 0.817
#>           Without  : ##################################### 0.825
#> bio18     With only: ################################## 0.762
#>           Without  : ####################################### 0.865
#> bio3      With only: ################################## 0.757
#>           Without  : ####################################### 0.875
#> landcover With only: ############################### 0.698
#>           Without  : ####################################### 0.875
#> bio6      With only: ############################### 0.69
#>           Without  : ####################################### 0.87
...
#>           Without  : ####################################### 0.87
#> bio2      With only: ########################### 0.595
#>           Without  : ####################################### 0.857
#> bio19     With only: ######################## 0.53
#>           Without  : ####################################### 0.872
#> bio14     With only: #################### 0.438
#>           Without  : ######################################## 0.879
#> ======================================================================
