...
#> 
#> row [124] - suspicious column: [bio14] - suspicious value: [1.00]
...
#> 	distribution: 92.593% <= 0.00 - [mean: 0.00] - [sd: 0.00] - [norm. obs: 25]
#> 	given:
#> 		[bio14] <= [1.00] (value: 0.00)
#> 		[bio5] > [39.79] (value: 41.24)
#> 
#> 
#> row [35] - suspicious column: [bio17] - suspicious value: [1.00]
#> 	distribution: 92.593% <= 0.00 - [mean: 0.00] - [sd: 0.00] - [norm. obs: 25]
#> 	given:
#> 		[bio14] <= [1.00] (value: 0.00)
...
#> 
#> 
#> row [100] - suspicious column: [bio14] - suspicious value: [1.00]
#> 	distribution: 98.833% <= 0.00 - [mean: 0.00] - [sd: 0.00] - [norm. obs: 254]
#> 	given:
...
<img src="itsdm-outliers-1.png" alt="plot of chunk outliers" style="display: block; margin: auto;" />
...
#> bio1   1.00  0.02 -0.22  0.65  0.04 -0.41 -0.41  0.27
#> bio2   0.02  1.00 -0.43 -0.66 -0.56 -0.47 -0.35 -0.30
#> bio3  -0.22 -0.43  1.00  0.43  0.34  0.44  0.23  0.23
#> bio6   0.65 -0.66  0.43  1.00  0.45  0.10 -0.09  0.47
#> bio12  0.04 -0.56  0.34  0.45  1.00  0.59  0.50  0.54
#> bio14 -0.41 -0.47  0.44  0.10  0.59  1.00  0.43  0.30
#> bio18 -0.41 -0.35  0.23 -0.09  0.50  0.43  1.00 -0.07
#> bio19  0.27 -0.30  0.23  0.47  0.54  0.30 -0.07  1.00
...
<img src="itsdm-prediction-1.png" alt="plot of chunk prediction" style="display: block; margin: auto;" />
...
#> CVI with 0.25 threshold:      0.027
#> CVI with 0.5 threshold:       0.237
#> CVI with 0.75 threshold:      0.581
#> CBI:                          0.752
#> AUC (ratio)                   0.869
#> ===================================
...
#> AUC:                          0.861
#> Similarity indices:
#> Jaccard's similarity index:   0.658
#> Sørensen's similarity index:  0.793
#> Overprediction rate:          0.214
#> Underprediction rate:         0.199
plot(it_sdm$eval_test)
```

<img src="itsdm-eval-1.png" alt="plot of chunk eval" style="display: block; margin: auto;" />
...
<img src="itsdm-marginal_responses-1.png" alt="plot of chunk marginal_responses" style="display: block; margin: auto;" />
...
<img src="itsdm-independent_responses-1.png" alt="plot of chunk independent_responses" style="display: block; margin: auto;" />
...
<img src="itsdm-variable_dependence-1.png" alt="plot of chunk variable_dependence" style="display: block; margin: auto;" />
...
#> [Training dataset]:
#> bio12     With only: ////////////////////////////////// 0.762
#>           Without  : //////////////////////////////////////////// 0.977
#> landcover With only: //////////////////////////// 0.622
#>           Without  : //////////////////////////////////////////// 0.983
#> bio18     With only: //////////////////////////// 0.613
#>           Without  : //////////////////////////////////////////// 0.983
#> bio3      With only: /////////////////////////// 0.598
#>           Without  : //////////////////////////////////////////// 0.972
#> bio19     With only: //////////////////////// 0.523
#>           Without  : /////////////////////////////////////////// 0.95
#> bio6      With only: ////////////////////// 0.485
#>           Without  : //////////////////////////////////////////// 0.988
#> bio1      With only: //////////////////// 0.451
#>           Without  : //////////////////////////////////////////// 0.982
#> wdpa      With only: /////////////////// 0.429
#>           Without  : //////////////////////////////////////////// 0.987
#> bio14     With only: //////////////// 0.36
#>           Without  : //////////////////////////////////////////// 0.981
#> bio2      With only: /////////////// 0.336
#>           Without  : //////////////////////////////////////////// 0.988
#> [Test dataset]:
#> bio12     With only: /////////////////////////////////// 0.775
#>           Without  : //////////////////////////////////////////// 0.977
#> landcover With only: /////////////////////////// 0.606
#>           Without  : //////////////////////////////////////////// 0.984
#> bio19     With only: /////////////////////////// 0.591
#>           Without  : /////////////////////////////////////////// 0.946
#> bio3      With only: ////////////////////////// 0.582
#>           Without  : //////////////////////////////////////////// 0.976
#> bio18     With only: //////////////////////// 0.539
#>           Without  : //////////////////////////////////////////// 0.987
#> bio6      With only: //////////////////// 0.453
#>           Without  : //////////////////////////////////////////// 0.987
#> wdpa      With only: /////////////////// 0.43
#>           Without  : //////////////////////////////////////////// 0.987
#> bio1      With only: ////////////////// 0.405
#>           Without  : //////////////////////////////////////////// 0.984
#> bio14     With only: //////////////// 0.362
#>           Without  : //////////////////////////////////////////// 0.982
#> bio2      With only: ///////////// 0.299
#>           Without  : ///////////////////////////////////////////// 0.99
#> ======================================================================
#> Jackknife test
#> Based on AUC ratio (Max value of traing and test are 0.871 and 0.869)
#> [Training dataset]:
#> bio12     With only: ////////////////////////////////////// 0.847
#>           Without  : ////////////////////////////////////// 0.852
#> bio18     With only: //////////////////////////////////// 0.796
#>           Without  : /////////////////////////////////////// 0.872
#> bio3      With only: ////////////////////////////////// 0.761
#>           Without  : /////////////////////////////////////// 0.869
#> bio6      With only: //////////////////////////////// 0.717
#>           Without  : /////////////////////////////////////// 0.871
#> bio1      With only: /////////////////////////////// 0.693
#>           Without  : /////////////////////////////////////// 0.862
#> landcover With only: /////////////////////////////// 0.681
#>           Without  : //////////////////////////////////////// 0.892
#> wdpa      With only: ////////////////////////////// 0.675
#>           Without  : /////////////////////////////////////// 0.869
#> bio2      With only: ///////////////////////////// 0.644
#>           Without  : /////////////////////////////////////// 0.87
#> bio19     With only: //////////////////////// 0.529
#>           Without  : //////////////////////////////////////// 0.885
#> bio14     With only: //////////////////// 0.442
#>           Without  : //////////////////////////////////////// 0.889
#> [Test dataset]:
#> bio12     With only: ///////////////////////////////////// 0.82
#>           Without  : ////////////////////////////////////// 0.854
#> bio18     With only: /////////////////////////////////// 0.771
#>           Without  : /////////////////////////////////////// 0.871
#> bio3      With only: ///////////////////////////////// 0.737
#>           Without  : /////////////////////////////////////// 0.874
#> landcover With only: /////////////////////////////// 0.699
#>           Without  : //////////////////////////////////////// 0.89
#> bio1      With only: /////////////////////////////// 0.696
#>           Without  : /////////////////////////////////////// 0.863
#> bio6      With only: /////////////////////////////// 0.679
#>           Without  : /////////////////////////////////////// 0.871
#> wdpa      With only: ////////////////////////////// 0.67
#>           Without  : /////////////////////////////////////// 0.873
#> bio2      With only: /////////////////////////// 0.602
#>           Without  : /////////////////////////////////////// 0.87
#> bio19     With only: /////////////////////// 0.503
#>           Without  : //////////////////////////////////////// 0.894
#> bio14     With only: /////////////////// 0.414
#>           Without  : //////////////////////////////////////// 0.891
#> ======================================================================
...
<img src="itsdm-var_contrib_general-1.png" alt="plot of chunk var_contrib_general" style="display: block; margin: auto;" />
...
<img src="itsdm-pa-1.png" alt="plot of chunk pa" style="display: block; margin: auto;" />
...
<img src="itsdm-var_inter_dependence-1.png" alt="plot of chunk var_inter_dependence" style="display: block; margin: auto;" />
...
<img src="itsdm-var_contrib-1.png" alt="plot of chunk var_contrib" style="display: block; margin: auto;" />
