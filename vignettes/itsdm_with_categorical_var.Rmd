...
variables <- do.call(c, list(split(bios, 'band'), 
                             wdpa, landcover)) %>% 
  merge(name = 'band'); rm(fname, bios, wdpa, landcover)
```
...
to a bunch of observations. It also allows you to set a desirable threshold.
...
```{r virtualspecies, fig.align='center', fig.width=7, fig.height=6}
